...
export class PatrolOfficerVisitorSubCarPark extends BaseEntity {
    @ManyToOne(() => PatrolOfficer, (patrolOfficer) => patrolOfficer.patrolOfficerVisitorSubCarParks)
    ...
    @ManyToOne(() => SubCarPark, (subCarPark) => subCarPark.patrolOfficerVisitorSubCarParks)
