...
export class PatrolOfficerWhitelistSubCarPark extends BaseEntity {
    @ManyToOne(() => PatrolOfficer, (patrolOfficer) => patrolOfficer.patrolOfficerWhitelistSubCarParks)
    ...
    @ManyToOne(() => SubCarPark, (subCarPark) => subCarPark.patrolOfficerWhitelistSubCarParks)
