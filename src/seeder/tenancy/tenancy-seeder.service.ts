    ...
    private async seed() {
        ...
        for (const tenancyData of tenancies) {
            ...
            if (!existingTenancy) {
                ...
                if (!subCarPark) {
                    this.logger.warn(`SubCarPark with code ${tenancyData.subCarParkCode} not found for Tenancy ${tenancyData.tenantName}`);
                    continue;
                }
                ...
                this.logger.log(`Tenancy ${tenancyData.tenantName} seeded for SubCarPark ${tenancyData.subCarParkCode}`);
            } else {
