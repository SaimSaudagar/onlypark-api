...
export class VisitorBookingService {
    ...
    async create(createVisitorBookingDto: CreateVisitorBookingRequest): Promise<CreateVisitorBookingResponse> {
        const { email, registrationNumber, subCarParkId, tenancyId } = createVisitorBookingDto;
