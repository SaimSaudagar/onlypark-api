export class ConfigKeys {
  ...
  public static readonly TWO_FACTOR_AUTH_TOKEN_SECRET =
    "TWO_FACTOR_AUTH_TOKEN_SECRET";
  public static readonly TWO_FACTOR_AUTH_TOKEN_SECRET_EXPIRATION_TIME =
    "TWO_FACTOR_AUTH_TOKEN_SECRET_EXPIRATION_TIME";
  ...
  // Geolocation
  public static readonly DEFAULT_GEOLOCATION_RADIUS =
...
export class ConfigConstants {
  ...
  public static readonly AUTH_PROVIDER_STRATEGY_DI_KEY =
    "AUTH_PROVIDER_STRATEGY";
