...
export class CarparkManagerBlacklistSubCarPark extends BaseEntity {
    @ManyToOne(() => CarparkManager, (carparkManager) => carparkManager.carparkManagerBlacklistSubCarParks)
    ...
    @ManyToOne(() => SubCarPark, (subCarPark) => subCarPark.carparkManagerBlacklistSubCarParks)
