...
import { CreateProfileRequest, UpdateProfileRequest } from "./profile.dto";
...
export class ProfileService {
  ...
  async findAll(
    options?: FindManyOptions<CarparkManager>,
  ): Promise<CarparkManager[]> {
    return await this.carparkManagerRepository.find(options);
  }

  async findOne(
    options?: FindOneOptions<CarparkManager>,
  ): Promise<CarparkManager> {
