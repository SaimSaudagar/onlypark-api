...
import { CreateBlacklistRequest, CreateBlacklistResponse, FindBlacklistRequest, FindBlacklistResponse, UpdateBlacklistRequest, UpdateBlacklistResponse, GetAssignedSubCarParksResponse } from './blacklist.dto';
...
export class BlacklistService extends BaseService {
    ...
    async getAssignedSubCarParks(): Promise<GetAssignedSubCarParksResponse[]> {
        ...
        return carparkManager.carparkManagerBlacklistSubCarParks?.map(assignment => ({
